...
$id = $_GET['id'];
    ...
    $update = "SELECT * FROM CATEGORIES where category_id = '$id'";
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" class="form-control" placeholder="Category Name" required value= "<?php echo $result['category_name']; ?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo $result['category_image'] ?>" style="height: 100px; width: 100px; border-radius: 20px;" alt="">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="category_desc" id="" cols="30" rows="10" placeholder="Category Description"
                                        Style="width: 100%;" required><?php echo $result['category_desc']; ?></textarea>
                                </div>
                            </div>
...
<?php
    if (isset($_POST['update'])) {
        ...
        $update_query = "UPDATE CATEGORIES SET category_name = '$category_name', category_image = '$folder', category_desc = '$category_desc'  WHERE category_id = '$id' ";
