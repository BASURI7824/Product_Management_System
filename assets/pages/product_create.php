...
<?php
    if (isset($_POST['submit'])) {
        ...
        $insert_query = "INSERT INTO products (category_id, product_name, product_price, product_image, product_description) VALUES ('$pro_cat', '$product_name', '$product_price', '$folder', '$product_description')";
        ...
        if($run_query){
            ...
            echo " <script> alert('Product has not been submitted')</script> "; 
            echo " <script>window.open('product.php', '_self')</script> ";
        }
    }
